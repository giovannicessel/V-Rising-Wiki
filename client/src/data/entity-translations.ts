...
export const ENTITY_NAME_PT: Record<string, string> = {
  ...
  'Heart Strike': 'Golpe de Coração',
  'Rain of Chaos': 'Chuva do Caos',
  'Arctic Storm': 'Tempestade Ártica',
  'Crystal Lance': 'Lança de Cristal',
  'Frost Barrier': 'Barreira de Gelo',
  'Arctic Leap': 'Salto Ártico',
  'Ice Block': 'Bloco de Gelo',
  'Frost Vortex': 'Vórtice de Gelo',
  'Ball Lightning': 'Bola de Raios',
  Cyclone: 'Ciclone',
  Discharge: 'Descarga',
  'Lightning Curtain': 'Cortina de Relâmpagos',
  'Lightning Tendrils': 'Tentáculos de Relâmpago',
  'Polarity Shift': 'Mudança de Polaridade',
  'Lightning Typhoon': 'Tufão de Relâmpagos',
  'Raging Tempest': 'Tempestade Furiosa',
  'Eye Of The Storm': 'Olho da Tempestade',
  'Bone Explosion': 'Explosão Óssea Profana',
  'Corrupted Skull': 'Caveira Corrompida',
  'Ward of the Damned': 'Barreira dos Condenados',
  'Death Knight': 'Cavaleiro da Morte',
  Soulburn: 'Incinerar Alma',
  'Army Of The Dead': 'Exército dos Mortos',
  'Volatile Arachnid': 'Aracnídeo Volátil',
  Purgatory: 'Purgatório',
  'Summon Fallen Angel': 'Convocar Anjo Caído',
  'Unstable Mosquito': 'Mosquito Instável',
  'Phantom Aegis': 'Égide Fantasma',
  'Spectral Wolf': 'Lobo Espectral',
  'Wraith Spear': 'Lança Espectral',
  Curse: 'Maldição',
  'Mist Trance': 'Transe da Névoa',
  'Mosquito (Spell)': 'Mosquito (Magia)',
  'Spectral Guardian': 'Guardião Espectral',
  'Wisp Dance': 'Dança das Fagulhas',
  'Mirror Strike': 'Golpe do Espelho',
  "Serpent's Kiss": 'Beijo da Serpente',
  'Spectral Assassin': 'Assassino Espectral',
